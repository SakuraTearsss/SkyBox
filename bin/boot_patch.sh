...
./bin/magiskboot compress=xz ./Magisk/magisk32 magisk32.xz
./bin/magiskboot compress=xz ./Magisk/magisk64 magisk64.xz
./bin/magiskboot compress=xz ./bin/stub.apk stub.xz
